    ...
    while($list=mysqli_fetch_array($cari)){?>
        <tr id="list">
            ...
            <td class="action-book">
                ...
                <?php }else{?><a href="pro-delete-book.php?id=<?php echo"$list[id]";?>" onclick="return confirm('Yakin ingin hapus ebook <?php echo"$list[nama_buku]";?> ?');"><img src="images/info-red.png" /></a><?php }?>
            </td>
        </tr>
